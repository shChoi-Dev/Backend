...
<html>
	...
	<body>
		<h3>파일 업로드</h3>
		<form id="fileUploadFrm" method="post" 	action="<c:url value='/fileUpload'/>" enctype="multipart/form-data">
		...
		<hr>
		<h3>여러 개의 파일 업로드</h3>
		<form id="fileUploadFrmMulti" method="post" action="<c:url value='/fileUploadMultiple'/>" enctype="multipart/form-data">
		...
		<form id="fileOriginalNameUploadForm" method="post" action="<c:url value='/fileOriginalNameUpload'/>" enctype="multipart/form-data">
			파일 : <input type="file" id="uploadFileOriginal" name=	"uploadFileOriginal"><br><br>
			<input type="submit" value="업로드">
		</form>
	</body>
</html>